...
var req = request('https://www.youtube.com/feeds/videos.xml?channel_id=UCTFBB20XR5lcLI-G2i-0gXg');
...
var serialdate="";
  ...
  if(item.title.includes("Epi")){
    var titleArr=item.title.split(" ");
    var stindex=titleArr.indexOf("Epi");
  ...
  if(item.title.includes("Apoorva Raagangal")){
    tags="Apoorva Raagangal"+","+"tamil serial"+"suntv";
